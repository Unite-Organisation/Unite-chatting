...
public class Message extends TableImpl<MessageRecord> {
     ...
     */
    public final TableField<MessageRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("gen_random_uuid()"), SQLDataType.UUID)), this, "");
     ...
     */
    public final TableField<MessageRecord, UUID> CONVERSATION_ID = createField(DSL.name("conversation_id"), SQLDataType.UUID, this, "");
    ...
    /**
     * The column <code>public.message.send_at</code>.
     */
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_MESSAGE_CONVERSATION_PAGINATION);
    }
    ...
    public MessagesReadPath messagesRead() {
        if (_messagesRead == null)
            _messagesRead = new MessagesReadPath(this, null, Keys.MESSAGES_READ__MESSAGES_READ_MESSAGE_ID_FKEY.getInverseKey());
