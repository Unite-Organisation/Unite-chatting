...
public class UserRole extends TableImpl<UserRoleRecord> {
     ...
     */
    public final TableField<UserRoleRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>public.user_role.user_role</code>.
     */
    public final TableField<UserRoleRecord, String> USER_ROLE_ = createField(DSL.name("user_role"), SQLDataType.VARCHAR(15).nullable(false), this, "");
    ...
    public AppUserPath appUser() {
        if (_appUser == null)
            _appUser = new AppUserPath(this, null, Keys.APP_USER__APP_USER_USER_ROLE_FKEY.getInverseKey());
